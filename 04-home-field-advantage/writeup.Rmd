...
In the simulation with home filed advantage, the absolute error is 0.000169, and the relative error is 0.000280.
...
In the simulation without home filed advantage, the absolute error is 0.000172, and the relative error is 0.000283.
...
Enumerate `advantage_multiplier` in the range of (1,2) with the break of 0.01.
