...
After changing Starting Budget with five specific numbers around B's starting value and doing 1000 times simulations for each Starting Budget, it shows that the more starting budget the gambler has, the more average earnings the gambler will get as the budget starts from 300 dollars.
...
After changing Winnings Threshold for Stopping with five specific numbers around W's starting value and doing 1000 times simulations for each Winnings Threshold for Stopping, it shows a positive relationship between Winnings Threshold for Stopping and Average Earning. The more winnings threshold for stopping is, the more average earnings the gambler will get.
...
After changing Casino’s Maximum Wager with five specific numbers around M's starting value and doing 1000 times simulations for each Casino’s Maximum Wager, it shows a positive relationship between Casino’s Maximum Wager and Average Earning. The more casino’s maximum wager is, the more average earnings the gambler will get.

In conclusion, changing parameters B, W and M will have impact on average earnings and most are positive impact as the parameters increase.
